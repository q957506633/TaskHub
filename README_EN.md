...
python build_exe.py          # or build_exe.bat
# Output: dist/TaskHub/ (TaskHub.exe + _internal + data + 使用说明.txt)
```
...
├── build_exe.py / build_exe.bat  # PyInstaller packaging (onedir)
├── TaskHub.spec          # PyInstaller spec
├── 使用说明.txt          # User guide shipped with the exe
